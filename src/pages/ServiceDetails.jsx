            ...
            <div className="col-lg-4">
              <div className="service-details-left">
                ...
                <div
                  ...
                  data-wow-delay=".4s"
                >
                  <h3 className="text-uppercase">GET TOUCH</h3>
                  <span className="fast">For fast service</span>
            ...
            <div className="col-lg-8">
              <div className="service-wrapper-right ps-xl-2">
                <div className="thumb mb-30 wow fadeInUp" data-wow-delay=".3s">
                  <img
                    src="../src/assets/img/service/service-single2.jpg"
                    alt="img"
                  />
                </div>
                <div className="cont-box wow fadeInUp" data-wow-delay=".4">
                  ...
                  <p>
                    ...
                    of the printing Lorem Ipsum is si dummy text of the printing
                    .Lorem Ipsum
                  </p>
                </div>
                <div className="working-process-details">
                  ...
                  >
                    ...
                    <div className="details-iconbox d-center">
                      <img
                        src="../src/assets/img/icon/details-desert.svg"
                        alt="img"
                      />
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="details-iconbox d-center">
                      <img
                        src="../src/assets/img/icon/details-flower.svg"
                        alt="img"
                      />
                    </div>
                  </div>
                ...
                >
                  ...
                  <p>
                    It is a long esta asblished fact that a reader will be distr
                    acted byoi the read able content of a page when lookiing for
                    okngjo at its layout The point of using Lorem Ipsum is that
                    it has a more orless norimal dist ribution of letters
                    opposed to using It is a long estab lished fact that a
                    readey
                  </p>
                </div>
                <div className="service-single-thumb">
                  <div className="thumb wow fadeInUp" data-wow-delay=".7s">
                    <img
                      src="../src/assets/img/service/service-details-big.jpg"
                      alt="img"
                    />
                  </div>
                  <div className="thumb wow fadeInUp" data-wow-delay=".8s">
                    <img
                      src="../src/assets/img/service/service-single1.jpg"
                      alt="img"
                    />
                  </div>
                </div>
