        ...
        <div className="container">
            <div className="row g-xl-4 g-3 justify-content-center">
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02 service-style03">
                        <div className="thumb w-100">
                            <img src="../src/assets/img/service/srp1.jpg" alt="img" className="w-100 mimg" />
                        </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02 service-style03">
                        <div className="thumb w-100">
                            <img src="../src/assets/img/service/srp2.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <a href="service-details.html" className="title">Harvest Tech to Farm Service</a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02 service-style03">
                        <div className="thumb w-100">
                            <img src="../src/assets/img/service/srp3.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <a href="service-details.html" className="title">AgriPro is the Consulting</a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02 service-style03">
                        <div className="thumb w-100">
                            <img src="../src/assets/img/service/srp4.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <a href="service-details.html" className="title">HarvestTech the best farm</a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02 service-style03">
                        <div className="thumb w-100">
                            <img src="../src/assets/img/service/srp5.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <a href="service-details.html" className="title">AgriTech to the a Innovations</a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02 service-style03">
                        <div className="thumb w-100">
                            <img src="../src/assets/img/service/srp6.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <a href="service-details.html" className="title">Crop Agriculture Solutions</a>
