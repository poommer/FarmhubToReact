          ...
          <div className="row g-xl-4 g-3 justify-content-center">
            ...
            >
              <div className="gallery-static-item">
                <img
                  src="src/assets/img/gallery/mg1.jpg"
                  alt="img"
                  className="w-100 mimg"
                />
                <div className="content">
                  <span>Business Intelligence</span>
                  <a href="gallery-details.html" className="title">
                    Vibrant Blooms the a Farming Services
                  </a>
                </div>
              </div>
            </div>
            ...
            >
              <div className="gallery-static-item">
                <img
                  src="src/assets/img/gallery/mg2.jpg"
                  alt="img"
                  className="w-100 mimg"
                />
                <div className="content">
            ...
            >
              <div className="gallery-static-item">
                <img
                  src="src/assets/img/gallery/mg3.jpg"
                  alt="img"
                  className="w-100 mimg"
                />
                <div className="content">
            ...
            >
              <div className="gallery-static-item">
                <img
                  src="src/assets/img/gallery/mg4.jpg"
                  alt="img"
                  className="w-100 mimg"
                />
                <div className="content">
            ...
            >
              <div className="gallery-static-item">
                <img
                  src="src/assets/img/gallery/mg5.jpg"
                  alt="img"
                  className="w-100 mimg"
                />
                <div className="content">
            ...
            >
              <div className="gallery-static-item">
                <img
                  src="src/assets/img/gallery/mg6.jpg"
                  alt="img"
                  className="w-100 mimg"
                />
                <div className="content">
