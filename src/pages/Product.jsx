            ...
            <div className="col-lg-3">
              <div className="product-list-leftbar">
                ...
                <div className="d-flex align-items-center justify-content-between mb-24 mt-3">
                  <span className="total-price">Price $30 - $1500</span>
                  ...
                  <ul className="product-list">
                    <li>
                      <a href="product-details.html">
                        <span className="name">Wheat</span>01
                      </a>
                    </li>
                    <li>
                      <a href="product-details.html">
                        <span className="name">Rice</span>02
                      </a>
                    </li>
                    <li>
                      <a href="product-details.html">
                        <span className="name">Meat</span>03
                      </a>
                    </li>
                    <li>
                      <a href="product-details.html">
                        <span className="name">Corn</span>04
                      </a>
                    </li>
                    <li>
                      <a href="product-details.html">
                        <span className="name">Oats</span>05
                      </a>
                    </li>
                    <li>
                      <a href="product-details.html">
                        <span className="name">Cotton</span>06
                      </a>
                    </li>
                    <li>
                      <a href="product-details.html">
                        <span className="name">Sunflower</span>07
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <div className="filter-mixtup">
                ...
                <div className="all-catagorys">
                  ...
                  <div className="mix category-b" data-order="2">
                    <div className="feature-itemsv1">
                      <img
                        src="src/assets/img/gallery/feature7.jpg"
                        alt="img"
                        className="f-thumb"
                      />
                      <div className="content">
                  ...
                  <div className="mix category-c" data-order="3">
                    <div className="feature-itemsv1">
                      <img
                        src="src/assets/img/gallery/feature8.jpg"
                        alt="img"
                        className="f-thumb"
                      />
                      <div className="content">
