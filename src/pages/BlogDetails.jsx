              ...
              <div className="blog-post-details">
                <div className="explore-details-content">
                  ...
                  <p className="fist-pra wow fadeInUp" data-wow-delay=".4s">
                    ...
                    text It has roots in a piece of classNameNameical the a
                    literature from 45 BC making it over 2000 years old. Richard
                    McClintock a Latin professor at Hampden-a Sydney College
                    Virgini the looked up one of the more obscure
                  </p>
                  <p className="mb-40 wow fadeInUp" data-wow-delay=".5">
                    Contrary to popular belief Lorem Ipsum is not simply random
                    text It has roots in a piece of classNameNameical a the a
                    literature from 45 BC making it over 2000 years old. Richard
                  ...
                  >
                    <img
                      src="../src/assets/img/blog/bd1.jpg"
                      alt="img"
                      className="w-100"
                    />
                  </div>
                  ...
                  <p className="fist-pra wow fadeInUp" data-wow-delay=".4s">
                    Contrary to popular belief Lorem Ipsum is not simply random
                    text It has roots in a piece of classNameNameical the
                    literature from 45 BC making it over 2000 years old. Richard
                    McClintock a Latin professoContrary to and popular belief
                  ...
                  >
                    <div className="thumb w-100">
                      <img
                        src="../src/assets/img/blog/bd-single1.jpg"
                        alt="img"
                        className="w-100"
                      />
                    </div>
                    <div className="thumb w-100">
                      <img
                        src="../src/assets/img/blog/bd-single2.jpg"
                        alt="img"
                        className="w-100"
                      />
                    </div>
                ...
                >
                  <div className="left-tag">
                    ...
                    <ul className="tag-list">
                      ...
                      <li>
                        <a href="blog-details.html">Beauity</a>
                      </li>
                      <li>
                        <a href="blog-details.html">Good</a>
                      </li>
                    </ul>
                  </div>
                ...
                >
                  <img
                    src="../src/assets/img/blog/reply-kishan.png"
                    alt="img"
                    className="krishana"
                  />
                  <div className="content">
                    ...
                    <p>
                      ...
                      random text. It has roots in a piece of classNameNameical
                ...
                >
                  ...
                  <div className="recent-postwrap">
                    ...
                    <div className="recent-items">
                      <div className="recent-thumb">
                        <img
                          src="../src/assets/img/blog/details-small2.png"
                          alt="img"
                        />
                      </div>
                      <div className="recent-content">
                    ...
                    <div className="recent-items">
                      <div className="recent-thumb">
                        <img
                          src="../src/assets/img/blog/details-small13.png"
                          alt="img"
                        />
                      </div>
                      <div className="recent-content">
