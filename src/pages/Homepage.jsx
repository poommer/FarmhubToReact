export function Homepage_1() {
                                                    ...
                                                    <div className="homemenu-items">
                                                        <div className="homemenu">
                                                            <div className="homemenu-thumb">
                                                                <img src="src/assets/img/header/home-1.jpg" alt="img"/>
                                                                <div className="demo-button">
                                                                    <a href="index.html" className="theme-btn p5-bg">
                                                                        <span>Home 01</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="homemenu">
                                                            <div className="homemenu-thumb mb-15">
                                                                <img src="src/assets/img/header/home-2.jpg" alt="img"/>
                                                                <div className="demo-button">
                                                                    <a href="index-2.html" className="theme-btn p5-bg">
                                                                        <span>Home 02</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="homemenu">
                                                            <div className="homemenu-thumb mb-15">
                                                                <img src="src/assets/img/header/home-3.jpg" alt="img"/>
                                                                <div className="demo-button">
                                                                    <a href="index-3.html" className="theme-btn p5-bg">
                                                                        <span>Home 03</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                        ...
                        <div className="shop-adjust">
                            <div className="shop-bar">
                                <div className="cart position-relative">
                                    ...
                                    <span className="serial-count d-center">
                                        0
                                    </span>
                                </div>
                                Total <br/>
                            ...
                            <div className="header-button d-sm-block d-none">
                                <a href="contact.html" className="cmn-btn d-center round100 cmn-white-clr">
                                    Get A Quote
                                    <i className="fa-solid fa-arrow-right"></i>
                                </a>
                            </div>
            ...
            <div className="row g-4 align-items-center position-relative">
                <div className="col-lg-7 col-md-7 col-sm-9">
                    <div className="hero-contentv01">
                        ...
                        <a href="about.html" className="cmn-btn round100 wow fadeInUp" data-wow-delay="0.9s">
                            View More
                            <i className="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div className="col-lg-5 col-md-5 col-sm-8">
                    <div className="hero-thumbv01 position-relative wow fadeInDown" data-wow-delay="0.5s">
                        <img src="src/assets/img/banner/hero1.png" alt="img" className="mimg"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="container">
            ...
            <div className="row g-lg-4 g-3 justify-content-center">
                <div className="col-md-7 col-sm-7">
                    <a href="assets/img/gallery/gl1.jpg" className="gallery-com-thumb first-item img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl1.jpg" alt="img" className="round20"/>
                    </a>
                </div>
                <div className="col-md-5 col-sm-5">
                    <a href="assets/img/gallery/gl2.jpg" className="gallery-com-thumb first-item img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl2.jpg" alt="img" className="round20"/>
                    </a>
                </div>
                <div className="d-flex flex-sm-nowrap flex-wrap justify-content-between gap-lg-4 gap-3">
                    <a href="assets/img/gallery/gl3.jpg" className="gallery-com-thumb secound img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl3.jpg" alt="img" className="round20"/>
                    </a>
                    <a href="assets/img/gallery/gl4.jpg" className="gallery-com-thumb secound img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl4.jpg" alt="img" className="round20"/>
                    </a>
                    <div className="d-grid gap-lg-4 gap-3">
                        <a href="assets/img/gallery/gl5.jpg" className="gallery-com-thumb thard img-popup w-100 round20">
                            <img src="src/assets/img/gallery/gl5.jpg" alt="img" className="round20"/>
                        </a>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv1">
                        ...
                        <div className="content">
                            ...
                            <a href="service-details.html" className="arrows">Read More <i className="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section className="testimonial-section testimonial-style1 section-padding">
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/element/flower-badge.png" alt="img" className="flower-testimonial d-sm-block d-none"/>
    </section>
                    ...
                    <div className="row g-xl-6 g-4">
                        <div className="col-sm-6 wow fadeInDown" data-wow-delay=".4s">
                            <div className="who-box">
                                ...
                                <a href="about.html" className="title">Growing stron <br/> a feeding</a>
                            </div>
                        </div>
                        <div className="col-sm-6 wow fadeInDown" data-wow-delay=".6s">
                            <div className="who-box">
                                ...
                                <a href="about.html" className="title">Taking care of <br/> the Earth</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div className="feature-video">
        <div className="container">
            <div className="feature-video-wrap w-100">
                <img src="src/assets/img/about/feature-vid.jpg" alt="img" className="w-100"/>
                <a href="https://www.youtube.com/watch?v=ZP1XyLYraAA" className="video-cmn d-center video-popup"><i className="fa-solid fa-play"></i></a>
            </div>
        </div>
    </div>
    ...
    <section className="blog-section overflow-hidden blog-stylev1 white-bg space-top">
        <div className="container">
            ...
            <div className="row g-xl-4 g-3 justify-content-center">
                <div className="col-lg-4 col-md-6 col-sm-11 wow fadeInUp" data-wow-delay=".3s">
                    <div className="blog-itemsv1">
                        <div className="thumb w-100">
                            <img src="src/assets/img/blog/blog1.jpg" alt="img" className="w-100"/>
                        ...
                        <div className="content">
                            ...
                            <a href="blog-details.html" className="title">From Farm to Table an Agriculture</a>
                            <p>Agriculture and farming are essential industries that involve</p>
                            <a href="blog-details.html" className="arrows">Read More <i className="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-11 wow fadeInUp" data-wow-delay=".5s">
                    <div className="blog-itemsv1">
                        <div className="thumb w-100">
                            <img src="src/assets/img/blog/blog2.jpg" alt="img" className="w-100"/>
                            <div className="dates">
                                22 jan
                            </div>
                        </div>
                        <div className="content">
                            ...
                            <a href="blog-details.html" className="title">Farm fresh goodness for alle</a>
                            <p>Agriculture and farming are essential industries that involve</p>
                            <a href="blog-details.html" className="arrows">Read More <i className="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-11 wow fadeInUp" data-wow-delay=".7s">
                    <div className="blog-itemsv1">
                        <div className="thumb w-100">
                            <img src="src/assets/img/blog/blog3.jpg" alt="img" className="w-100"/>
                            <div className="dates">22 jan</div>
                        </div>
                        <div className="content">
                            <ul className="comment-inner">
                            ...
                            <a href="blog-details.html" className="title">Discover Potential of Agriculture</a>
                            <p>Agriculture and farming are essential industries that involve</p>
                            <a href="blog-details.html" className="arrows">Read More <i className="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/element/carrort-elemet-line.png" alt="img" className="carrot-left"/>
        <img src="src/assets/img/element/carrot-element-cricle.png" alt="img" className="carrot-right d-md-block d-none"/>
    </section>
                    ...
                    <div className="row g-4 justify-content-lg-start justify-content-between align-items-end">
                        <div className="col-lg-5 col-md-5">
                            <div className="subscribe-thumb">
                                <img src="src/assets/img/footer/subscribe.png" alt="img" className="w-100"/>
                            </div>
                        </div>
    ...
    <footer className="footer-section overflow-hidden position-relative footer-style1">
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/footer/footer-wheat.png" alt="img" className="footer-wheat position-absolute"/>
        {/* <!-- Element --> */}
    </footer>
    </>
    )
...
export function Homepage_2() {
    ...
    <section className="banner-section position-relative style-v2 overflow-hidden">
                    ...
                    <div className="col-lg-7 col-md-9">
                        <div className="banner-contentv02">
                            ...
                            <div className="banner-buttonv2 wow fadeInUp" data-wow-delay="1s">
                                <a href="about.html" className="cmn-btn round100 primary-border">
                                    Read More
                                    <i className="fa-solid fa-angle-right"></i>
                                </a>
        ...
        <img src="src/assets/img/banner/hero-v2.png" alt="img" className="hero-v02-thumb"/>
            ...
            <div className="row g-4 align-items-lg-center justify-content-center">
                <div className="col-lg-6 col-md-6 col-sm-8 order-md-0 order-1">
                    <div className="about-thumv02 position-relative w-100 wow fadeInDown" data-wow-delay=".3s">
                        <img src="src/assets/img/about/choose-thumb2.png" alt="img" className="w-100"/>
                    </div>
                </div>
                <div className="col-lg-6 col-md-6">
                    <div className="about-contentv1">
                        <div className="section-title mb-40">
                            ...
                            <p className="wow fadeInUp mb-lg-4 mb-3" data-wow-delay=".4s">
                                Lorem ipsum dolor sit amet consectetur. Amet lectus mi ultricies dictum se facilisis
            ...
            <div className="row g-xl-4 g-3 justify-content-center">
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="service-itemsv02">
                        <div className="thumb w-100">
                            <img src="src/assets/img/service/service1.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <div className="iocns-box d-center"><img src="src/assets/img/icon/desert.svg" alt="svg"/></div>
                            <a href="service-details.html" className="title">Green Grow Solutions</a>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div className="service-itemsv02">
                        <div className="thumb w-100">
                            <img src="src/assets/img/service/service2.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <div className="iocns-box d-center"><img src="src/assets/img/icon/fence.svg" alt="svg"/></div>
                            <a href="service-details.html" className="title">Farm Services</a>
                            <p>Amet lectus mi ultricies dictum facilisis sem. Imperdiet massa turpis</p>
                            <a href="service-details.html" className="arrows">Read More <i
                                    className="fa-solid fa-angle-right"></i></a>
                        </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
                    <div className="service-itemsv02">
                        <div className="thumb w-100">
                            <img src="src/assets/img/service/service3.jpg" alt="img" className="w-100 mimg"/>
                        </div>
                        <div className="content">
                            <div className="iocns-box d-center"><img src="src/assets/img/icon/tree.svg" alt="svg"/></div>
                            <a href="service-details.html" className="title">AgriPro Consulting</a>
                            <p>Amet lectus mi ultricies dictum facilisis sem. Imperdiet massa turpis</p>
                            <a href="service-details.html" className="arrows">Read More <i
                                    className="fa-solid fa-angle-right"></i></a>
                        </div>
    ...
    <section className="Working-section section-padding p900-bg">
            ...
            <div className="row g-xl-4 g-3 justify-content-center position-relative mb-60">
                <div className="col-lg-3 col-md-6 col-sm-6 wow fadeInDown" data-wow-delay=".3s">
                    <div className="working-proces-items01">
                        ...
                        <img src="src/assets/img/element/step-shape.png" alt="img" className="step-working"/>
                ...
                <img src="src/assets/img/element/arro-round-top.png" alt="img" className="working-arrows-one"/>
                <img src="src/assets/img/element/arro-round-bottom.png" alt="img"
        ...
        <img src="src/assets/img/element/sylli.png" alt="img" className="working-slilli"/>
        <img src="src/assets/img/element/green-area.png" alt="img" className="working-green"/>
    </section>
            ...
            <div className="row g-4 align-items-center">
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonail-common-items">
                                        <div className="d-flex justify-content-between">
                                            <div className="review-man">
                                                <img src="src/assets/img/testimonial/re2.png" alt="img"/>
                                                <div className="cont">
                                                    <h3>
                                                        Leslie Alexander
                                                    </h3>
                                            ...
                                            <img src="src/assets/img/icon/quote-leftp2.svg" alt="icon" className="qute"/>
                                        </div>
                                        <div className="stars">
                                            <i className="fa-solid fa-star"></i>
                                            <i className="fa-solid fa-star"></i>
                ...
                <div className="col-lg-6 col-md-6">
                    <div className="testimonial-thumbv2 w-100 wow fadeInDown" data-wow-delay=".4s">
                        <img src="src/assets/img/testimonial/testimonial-thumb2.png" alt="img" className="w-100"/>
            ...
            <div className="row g-xl-4 g-3 justify-content-center">
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div className="team-itemsv01">
                        <img src="src/assets/img/testimonial/team1.png" alt="img" className="mimg"/>
                            ...
                            <div className="social-sahre">
                                <div className="share-icon">
                                    <div className="social-wrapper social-empact">
                                        ...
                                        <a href="#" className="white-clr"><i
                                                className="white-clr fa-brands fa-linkedin-in"></i></a>
                                        <a href="#" className="white-clr"><i
                                                className="white-clr fa-brands fa-pinterest-p"></i></a>
                                    </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div className="team-itemsv01">
                        <img src="src/assets/img/testimonial/team2.png" alt="img" className="mimg"/>
                        <div className="contents">
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
                    <div className="team-itemsv01">
                        <img src="src/assets/img/testimonial/team3.png" alt="img" className="mimg"/>
                        <div className="contents">
                            <a href="#" className="title">Jane Cooper</a>
    ...
    <section className="counter-section02 position-relative">
        <div className="container">
            <div className="counter-version-wrapv1 d-flex align-items-center justify-content-between gap-4">
                ...
                <img src="src/assets/img/element/count-flower-left.png" alt="img" className="cout-flower-left"/>
                <img src="src/assets/img/element/count-flower-right.png" alt="img" className="cout-flower-right"/>
            </div>
        </div>
    </section>
    ...
    <div className="feature-videov02">
        <div className="container">
            <div className="feature-video-wrap d-center w-100">
                <a href="https://www.youtube.com/watch?v=ZP1XyLYraAA" className="video-cmn d-center video-popup">
            ...
            <div className="row g-4 align-items-xl-center flex-row-reverse justify-content-between">
                ...
                <div className="col-md-6">
                    <div className="taklking-cotnact-thumb w-100 wow fadeInRight" data-wow-delay=".4s">
                        <img src="src/assets/img/contact/talking-contact.png" alt="img" className="w-100"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="row g-xl-4 g-3 justify-content-center">
                <div className="col-xl-6 col-lg-5 col-md-10 col-sm-11 wow fadeInUp" data-wow-delay=".3s">
                    <div className="blog-itemsv1 blog-itemsv2">
                        <div className="thumb w-100">
                            <img src="src/assets/img/blog/blogv2-1.jpg" alt="img" className="w-100"/>
                        </div>
                        <ul className="comment-inner">
                            <li>
                        ...
                        <div className="content">
                            <a href="blog-details.html" className="title">Nourishing the world from seed to the best
                                table</a>
                            <a href="blog-details.html" className="arrows">Read More <i
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div className="blog-itemsv1 blog-itemsv2">
                        <div className="thumb w-100">
                            <img src="src/assets/img/blog/blogv2-2.jpg" alt="img" className="w-100"/>
                        </div>
                        <ul className="comment-inner">
                            <li>
                                <a href="#"><i className="fa-solid fa-calendar-days"></i> October 19, 2024</a>
                        ...
                        <div className="content">
                            <a href="blog-details.html" className="title">Sow harvest to the repeat</a>
                            <a href="blog-details.html" className="arrows">Read More <i
                                    className="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
                    <div className="blog-itemsv1 blog-itemsv2">
                        <div className="thumb w-100">
                            <img src="src/assets/img/blog/blogv2-13.jpg" alt="img" className="w-100"/>
                        </div>
                        <ul className="comment-inner">
                            <li>
                                <a href="#"><i className="fa-solid fa-calendar-days"></i> October 19, 2024</a>
                        ...
                        <div className="content">
                            <a href="blog-details.html" className="title">Discover the Pot of Agriculture</a>
                            <a href="blog-details.html" className="arrows">Read More <i
                                    className="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
    ...
    <div className="subscrbie-section">
        <div className="container">
            <div className="subscribe-wrapper-v02">
                <div className="container">
                    <div className="row g-4 align-items-center justify-content-between">
                        ...
                        <div className="col-lg-6 col-md-7">
                            <form action="#" className="subscribe-form02 flex-sm-nowrap flex-wrap">
                                <input type="text" placeholder="Enter Your Email"/>
                ...
                <img src="src/assets/img/footer/subscribe-shapev2.png" alt="img" className="subscribe-shapev2"/>
            </div>
        </div>
    </div>
    ...
    <footer className="footer-section overflow-hidden position-relative footer-style2">
                    ...
                    <div className="col-xl-4 col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="single-footer-widget">
                            ...
                            <div className="footer-content">
                                ...
                                <h5 className="white-clr fw-normal mb-3">
                                    Follow Us
                                </h5>
                                <div className="social-wrapper social-empact d-flex align-items-center">
                                    <a href="#" className="white-clr"><i className="white-clr fab fa-facebook-f"></i></a>
        ...
        <div className="footer-bottom">
            <div className="container">
                <div
                    className="footer-wrapper footer-wrapperv02 d-md-flex d-grid gap-md-0 gap-2 align-items-center justify-content-md-between justify-content-center text-md-start text-center">
                    <p className="wow fadeInLeft color-2" data-wow-delay=".3s">
                        &copy; theme_ocean 2024. All Rights Reserved
                    </p>
                    <ul className="footer-menu wow fadeInRight" data-wow-delay=".5s">
        ...
        <img src="src/assets/img/footer/footer-shape2.png" alt="img" className="footer-wheat position-absolute w-100"/>
...
return(
            ...
            <div class="row g-4 align-items-center position-relative">
                <div class="col-lg-7 col-md-7 col-sm-9">
                    <div class="hero-contentv01">
                        ...
                        <a href="about.html" class="cmn-btn round100 wow fadeInUp" data-wow-delay="0.9s">
                            View More
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-5 col-md-5 col-sm-8">
                    <div class="hero-thumbv01 position-relative wow fadeInDown" data-wow-delay="0.5s">
                        <img src="src/assets/img/banner/hero1.png" alt="img" class="mimg"/>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 align-items-center justify-content-center">
                <div class="col-lg-6 col-md-6 col-sm-8 order-md-0 order-1">
                    <div class="about-thumv01 position-relative">
                        <img src="src/assets/img/about/choose-man.png" alt="img" class="mimg"/>
                        {/* <!-- Elemennt --> */}
                        <img src="src/assets/img/about/f-food.png" alt="img" class="f-food"/>
                        <img src="src/assets/img/about/l-food.png" alt="img" class="l-food wow fadeInLeft"
                            data-wow-delay=".5s"/>
                        <img src="src/assets/img/about/t-food.png" alt="img" class="t-food wow fadeInLeft"
                            data-wow-delay=".7s"/>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row g-lg-4 g-3 justify-content-center">
                <div class="col-md-7 col-sm-7">
                    <a href="assets/img/gallery/gl1.jpg" class="gallery-com-thumb first-item img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl1.jpg" alt="img" class="round20"/>
                    </a>
                </div>
                <div class="col-md-5 col-sm-5">
                    <a href="assets/img/gallery/gl2.jpg" class="gallery-com-thumb first-item img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl2.jpg" alt="img" class="round20"/>
                    </a>
                </div>
                <div class="d-flex flex-sm-nowrap flex-wrap justify-content-between gap-lg-4 gap-3">
                    <a href="assets/img/gallery/gl3.jpg" class="gallery-com-thumb secound img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl3.jpg" alt="img" class="round20"/>
                    </a>
                    <a href="assets/img/gallery/gl4.jpg" class="gallery-com-thumb secound img-popup w-100 round20">
                        <img src="src/assets/img/gallery/gl4.jpg" alt="img" class="round20"/>
                    </a>
                    <div class="d-grid gap-lg-4 gap-3">
                        <a href="assets/img/gallery/gl5.jpg" class="gallery-com-thumb thard img-popup w-100 round20">
                            <img src="src/assets/img/gallery/gl5.jpg" alt="img" class="round20"/>
                        </a>
            ...
            <div class="row g-xl-4 g-3 justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="service-itemsv1">
                        <img src="src/assets/img/icon/count1.svg" alt="svg" class="icons"/>
                        <div class="content">
                            <a href="service-details.html" class="title">Green Grow</a>
                            <p>Agriculture and farming are essential industries</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="service-itemsv1">
                        <img src="src/assets/img/icon/wheat-sesh.svg" alt="svg" class="icons"/>
                        <div class="content">
                            <a href="service-details.html" class="title">Agri Consulting</a>
                            <p>Agriculture and farming are essential industries</p>
                            <a href="service-details.html" class="arrows">Read More <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay=".7s">
                    <div class="service-itemsv1">
                        <img src="src/assets/img/icon/smart-flower.svg" alt="svg" class="icons"/>
                        <div class="content">
                            <a href="service-details.html" class="title">Farm Smart</a>
                            <p>Agriculture and farming are essential industries</p>
                            <a href="service-details.html" class="arrows">Read More <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
    ...
    <section class="testimonial-section testimonial-style1 section-padding">
            ...
            <div class="row g-6 align-items-center">
                <div class="col-lg-4 col-md-4">
                    <div class="testimonial-thumbv1 w-100 wow fadeInDown" data-wow-delay=".4s">
                        <img src="src/assets/img/testimonial/testimonial.png" alt="img" class="w-100"/>
                    </div>
                </div>
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/element/flower-badge.png" alt="img" class="flower-testimonial d-sm-block d-none"/>
    </section>
                ...
                <div class="all-catagorys">
                    <div class="mix category-a" data-order="1">
                        <div class="feature-itemsv1">
                            <img src="src/assets/img/gallery/feature1.jpg" alt="img" class="f-thumb"/>
                            <div class="content">
                    ...
                    <div class="mix category-b" data-order="2">
                        <div class="feature-itemsv1">
                            <img src="src/assets/img/gallery/feature2.jpg" alt="img" class="f-thumb"/>
                            <div class="content">
                    ...
                    <div class="mix category-c" data-order="3">
                        <div class="feature-itemsv1">
                            <img src="src/assets/img/gallery/feature3.jpg" alt="img" class="f-thumb"/>
                            <div class="content">
                    ...
                    <div class="mix category-a" data-order="4">
                        <div class="feature-itemsv1">
                            <img src="src/assets/img/gallery/feature4.jpg" alt="img" class="f-thumb"/>
                            <div class="content">
                    ...
                    <div class="mix category-a category-c" data-order="5">
                        <div class="feature-itemsv1">
                            <img src="src/assets/img/gallery/feature5.jpg" alt="img" class="f-thumb"/>
                            <div class="content">
                    ...
                    <div class="mix category-b" data-order="6">
                        <div class="feature-itemsv1">
                            <img src="src/assets/img/gallery/feature6.jpg" alt="img" class="f-thumb"/>
                            <div class="content">
    ...
    <section class="who-section overflow-hidden p900-bg section-padding">
        <div class="container">
            <div class="row g-4 justify-content-between align-items-end">
                <div class="col-lg-6">
                    <div class="section-title mb-40">
                        <h5 class="p1-clr wow fadeInLeft" data-wow-delay="0.4s">Who we are</h5>
                        <h2 class="wow fadeInDown white-clr mb-24" data-wow-delay=".3s">Nourishing world from seed to table</h2>
                        <p class="white-clr wow fadeInDown" data-wow-delay=".4s">Agriculture and farming are essential industries that involve the cultivation of crops,raising of livestock, and production of food.</p>
                    </div>
                    <div class="row g-xl-6 g-4">
                        <div class="col-sm-6 wow fadeInDown" data-wow-delay=".4s">
                            <div class="who-box">
                                ...
                                <a href="about.html" class="title">Growing stron <br/> a feeding</a>
                            </div>
                        </div>
                        <div class="col-sm-6 wow fadeInDown" data-wow-delay=".6s">
                            <div class="who-box">
                                ...
                                <a href="about.html" class="title">Taking care of <br/> the Earth</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/element/who-element.png" alt="img" class="who-element"/>
    </section>
    ...
    <div class="feature-video">
        <div class="container">
            <div class="feature-video-wrap w-100">
                <img src="src/assets/img/about/feature-vid.jpg" alt="img" class="w-100"/>
                <a href="https://www.youtube.com/watch?v=ZP1XyLYraAA" class="video-cmn d-center video-popup"><i class="fa-solid fa-play"></i></a>
            </div>
        </div>
    </div>
    ...
    <section class="blog-section overflow-hidden blog-stylev1 white-bg space-top">
        <div class="container">
            ...
            <div class="row g-xl-4 g-3 justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-11 wow fadeInUp" data-wow-delay=".3s">
                    <div class="blog-itemsv1">
                        <div class="thumb w-100">
                            <img src="src/assets/img/blog/blog1.jpg" alt="img" class="w-100"/>
                            <div class="dates">22 jan</div>
                        </div>
                        <div class="content">
                            <ul class="comment-inner">
                                <li><a href="#"><i class="fa-regular fa-comments"></i> Comments (05)</a></li>
                            ...
                            <p>Agriculture and farming are essential industries that involve</p>
                            <a href="blog-details.html" class="arrows">Read More <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-11 wow fadeInUp" data-wow-delay=".5s">
                    <div class="blog-itemsv1">
                        <div class="thumb w-100">
                            <img src="src/assets/img/blog/blog2.jpg" alt="img" class="w-100"/>
                            <div class="dates">
                                22 jan
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-11 wow fadeInUp" data-wow-delay=".7s">
                    <div class="blog-itemsv1">
                        <div class="thumb w-100">
                            <img src="src/assets/img/blog/blog3.jpg" alt="img" class="w-100"/>
                            <div class="dates">22 jan</div>
                        </div>
                        <div class="content">
                            <ul class="comment-inner">
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/element/carrort-elemet-line.png" alt="img" class="carrot-left"/>
        <img src="src/assets/img/element/carrot-element-cricle.png" alt="img" class="carrot-right d-md-block d-none"/>
    </section>
                    ...
                    <div class="row g-4 justify-content-lg-start justify-content-between align-items-end">
                        <div class="col-lg-5 col-md-5">
                            <div class="subscribe-thumb">
                                <img src="src/assets/img/footer/subscribe.png" alt="img" class="w-100"/>
                            </div>
                        </div>
    ...
    <footer class="footer-section overflow-hidden position-relative footer-style1">
        ...
        {/* <!-- Element --> */}
        <img src="src/assets/img/footer/footer-wheat.png" alt="img" class="footer-wheat position-absolute"/>
        {/* <!-- Element --> */}
    </footer>
    </>
)
