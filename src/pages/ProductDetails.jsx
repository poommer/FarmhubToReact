            ...
            <div className="col-lg-3 col-md-5 pe-xl-4">
              <div className="product-details-leftbar mb-60">
                <div className="product-categori-select">
                  ...
                  <select name="cate">
                    <option value="1">Shop By Ctagory</option>
                    <option value="2">Fresh Meat</option>
                    <option value="3">Beef Meat</option>
                    <option value="4">Potatoes</option>
                    <option value="5">Soybean</option>
                  </select>
                </div>
                  ...
                  <div className="accordion-section d-grid gap-xxl-3 gap-lg-3 gap-2">
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc1.svg"
                            alt="icon"
                          />
                          Meat
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc2.svg"
                            alt="icon"
                          />
                          Sugar Cane
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc3.svg"
                            alt="icon"
                          />
                          Potatoes
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc4.svg"
                            alt="icon"
                          />
                          Rice
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc5.svg"
                            alt="icon"
                          />
                          Tractor
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc6.svg"
                            alt="icon"
                          />
                          Mower
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc7.svg"
                            alt="icon"
                          />
                          Plow
                        </button>
                    ...
                    <div className="accordion-single">
                      <h5 className="header-area">
                        ...
                        >
                          <img
                            src="../src/assets/img/icon/mc8.svg"
                            alt="icon"
                          />
                          Rake
                        </button>
                ...
                <div className="recent-postwrap">
                  <div className="recent-items">
                    <div className="recent-thumb">
                      <img
                        src="../src/assets/img/blog/details-small1.png"
                        alt="img"
                      />
                    </div>
                  ...
                  <div className="recent-items">
                    <div className="recent-thumb">
                      <img
                        src="../src/assets/img/blog/product-recente1.jpg"
                        alt="img"
                      />
                    </div>
                    <div className="recent-content">
                  ...
                  <div className="recent-items">
                    <div className="recent-thumb">
                      <img
                        src="../src/assets/img/blog/product-recente2.jpg"
                        alt="img"
                      />
                    </div>
                    <div className="recent-content">
                  ...
                  <div className="recent-items">
                    <div className="recent-thumb">
                      <img
                        src="../src/assets/img/blog/product-recente3.jpg"
                        alt="img"
                      />
                    </div>
                    <div className="recent-content">
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="shop-details-bigthumb">
                            <img
                              src="../src/assets/img/service/product-small6.jpg"
                              alt="img"
                            />
                          </div>
                        </div>
                      ...
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <div className="shop-details-samll d-center">
                            <img
                              src="../src/assets/img/service/product-small1.png"
                              alt="img"
                            />
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="shop-details-samll d-center">
                            <img
                              src="../src/assets/img/service/product-small2.png"
                              alt="img"
                            />
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="shop-details-samll d-center">
                            <img
                              src="../src/assets/img/service/product-small3.png"
                              alt="img"
                            />
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="shop-details-samll d-center">
                            <img
                              src="../src/assets/img/service/product-small4.png"
                              alt="img"
                            />
                          </div>
                        </div>
                        <div className="swiper-slide">
                          <div className="shop-details-samll d-center">
                            <img
                              src="../src/assets/img/service/product-small5.png"
                              alt="img"
                            />
                          </div>
                        </div>
                  ...
                  <div className="tabcontents">
                    <div className="tabitem">
                      <p className="dess">
                        ...
                        random text It has roots in a piece of classNameical the
                        a literature from 45 BC making it over 2000 years old.
                        ...
                        of classNameical the a literature from 45 BC making it
                        over 2000 years old. Richard McClintock a Latin
                        professor at Hampden-a Sydney College Virgini the looked
