  ...
  return (
    <>
      ...
      <section className="faq-section section-padding p100-bg">
                    ...
                    <div className="content-area">
                      <div className="content-body">
                        <p>
                          ...
                          looking at its layout. Many desktop publishing
                  ...
                  <div className="accordion-single">
                    ...
                    <div className="content-area">
                      <div className="content-body">
                        <p>
                          It is a long established fact that a reader will be
                          distracted by the read content of a page when looking
                          at its layout. Many desktop publish packages and web
                          page editors now use Loremdefault model
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        {/* <!-- Element --> */}
        <img
          src="src/assets/img/element/faq-element.png"
          alt="img"
      ...
      {/* <!-- Counter Section --> */}
      <section className="counter-sectionv03 counter-main-section section-padding position-relative">
        <div className="container">
          <div className="counter-version-wrapv1 d-flex align-items-center justify-content-between gap-4">
            ...
            <div className="count-animal d-lg-block d-none">
              <img src="src/assets/img/icon/count-animal.svg" alt="img" />
            </div>
            <div className="counter-items style02">
              <div className="con-box">
                <h2>
